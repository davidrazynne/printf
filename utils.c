...
/**
 * is_printable - Checks if a char is can be printed
...
/**
 * convert_size_number - mirrors a number to the specified size
 * @num: No. to be casted.
 * @size: No. indicating the type to be casted.
 *
 * Return: mirrored value of num
 */
...
/**
 * convert_size_unsgnd - shows a number to the specified size
